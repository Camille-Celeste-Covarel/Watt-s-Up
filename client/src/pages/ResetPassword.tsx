    ...
    return (
        <div className="reset-password-container">
            ...
            <form onSubmit={handleSubmit} className="reset-password-form">
                <div><label htmlFor="password">Choisissez votre nouveau mot de passe</label>
                    <input type="password"
                        id="password"
                        value={password}
                ...
                <div><label htmlFor="confirmation-password">Confirmez votre nouveau mot de passe</label>
                    <input type="password"
                ...
                <button type="submit" className="button-classic">Réinitialisez le mot de passe</button>
            </form>
